define(function(require, exports, module){
	...
	domReady(function () {
		...
		//require("compiled/risks_assessments");
		var $ = require("jquery");
		...
		$.each($categories, function(index1, category){
			...
			$.each($questions, function(index, question){
				...
				if(static_data.property.risks_assessments.length>0)
				{
					var data = static_data.property.risks_assessments.find(function(item){
				...
				data.property = {id: static_data.property.id};
