...
(function ($) {
    ...
    var CheckboxX = function (element, options) {
        ...
        self.initialValue = Number(self.$element.is(':checked'));
        self.init(options);
    };
    ...
    CheckboxX.prototype = {
        ...
        init: function (options) {
            var self = this, $el = self.$element, isCbx = $el.is(':checkbox'), val = Number($el.is(':checked')),
            ...
            if (isCbx && options.useNative) {
                ...
                self.setCheckboxProp(Number($el.is(':checked')));
                return;
            }
        ...
        calculate: function () {            
            var self = this, $el = self.$element, val = Number($el.is(':checked')),
        ...
        getIndicator: function () {
            var self = this,
                ...
                val = Number(self.$element.is(':checked'));
            ...
            var html = '<span class="cbx-icon">' + icon + '</span>';
            return html;
        },
        render: function () {
            var self = this,
